...
import com.example.saored.EditProfilePage;
...
public class AdapterChatList extends RecyclerView.Adapter<AdapterChatList.Myholder> {
	...
	public void onBindViewHolder(@NonNull Myholder holder, final int position) {
		...
		try {
			...
			Glide.with(context).load(strImage).placeholder(R.drawable.ic_avatar).into(holder.profile);		} catch (Exception e) {
			Glide.with(context).load(R.drawable.ic_avatar).into(holder.profile);
		}
